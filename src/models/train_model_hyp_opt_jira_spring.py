...
def train_model(model_name: str):
    """
    Trainiert ein Modell auf Jira-Daten und testet es auf Spring-Daten. Es wurden Hyperparameter eingefügt, die mittels Validation Set konfiguriert wurden.
    ...
    y_pred_static = model_static.predict(x_static_spring)
    ...
    y_pred_static_process = model_static_process.predict(x_static_process_spring)
