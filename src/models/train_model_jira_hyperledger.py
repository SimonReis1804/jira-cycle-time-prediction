...
def train_model(model_name: str):
    """
    Trainiert ein Modell auf Jira-Daten und testet es auf Hyperledger-Daten.
    ...
    y_pred_static = model.predict(x_static_hyperledger)
    ...
    y_pred_static_process = model.predict(x_static_process_hyperledger)
